      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <Card className="dark:bg-gray-800 dark:border-gray-700">
          <CardContent className="pt-6">
            <p className="text-gray-700 dark:text-gray-300 font-medium">{analysis.scoreJustification}</p>
          </CardContent>
        </Card>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          <Card className="dark:bg-gray-800 dark:border-gray-700">
            ...
            <CardContent>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">{analysis.executiveSummary}</p>
            </CardContent>
          </Card>
          ...
          <Card className="dark:bg-gray-800 dark:border-gray-700">
            ...
            <CardContent>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">{analysis.firstImpression}</p>
            </CardContent>
          </Card>
        </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {analysis.keywordAnalysis.matchingKeywords.length > 0 ? (
                  ...
                  <span className="text-sm text-gray-500 dark:text-gray-400">No keyword matches found</span>
                )}
              </div>
            </div>
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {analysis.keywordAnalysis.missingKeywords.length > 0 ? (
                  ...
                  <span className="text-sm text-gray-500 dark:text-gray-400">All important keywords are present</span>
                )}
              </div>
            </div>
          </CardContent>
          ...
          <Card className="dark:bg-gray-800 dark:border-gray-700">
            ...
            <CardContent>
              {analysis.experienceAlignment.dealBreakers.length > 0 ? (
                ...
                <div className="flex items-center gap-2 text-green-600">
                  <CheckCircle className="h-4 w-4" />
                  <span className="text-sm">No critical qualifications missing</span>
                </div>
              )}
            </CardContent>
          </Card>
        ...
        <div className="space-y-6">
          ...
          <Card className="dark:bg-gray-800 dark:border-gray-700">
            ...
            <CardContent className="space-y-4">
              {analysis.actionableRecommendations.improvedBulletPoints.map((bullet, index) => (
                <div key={index} className="space-y-2">
                  <div className="bg-red-50 dark:bg-red-900/20 p-3 rounded-lg border-l-4 border-red-400">
                    <p className="text-sm text-gray-600 dark:text-gray-400 font-medium">Original:</p>
                    <p className="text-sm text-gray-700 dark:text-gray-300">{bullet.original}</p>
                  </div>
                  <div className="bg-green-50 dark:bg-green-900/20 p-3 rounded-lg border-l-4 border-green-400">
                    <p className="text-sm text-gray-600 dark:text-gray-400 font-medium">Improved:</p>
                    <p className="text-sm text-gray-700 dark:text-gray-300">{bullet.improved}</p>
                  </div>
                </div>
              ))}
            </CardContent>
